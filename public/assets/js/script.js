(function($) {
	...
	if(document.querySelector('.mobile-menu').length){
		...
		var mobileMenuContent = document.querySelector('.main-header .menu-area .main-menu').html();
		...
		//Dropdown Button
		document.querySelector('.mobile-menu li.dropdown .dropdown-btn').addEventListener('click', function() {
			document.querySelector(this).classList.toggle('open');
			document.querySelector(this).prev('ul').slideToggle(500);
		});
		//Dropdown Button
		document.querySelector('.mobile-menu li.dropdown .dropdown-btn').addEventListener('click', function() {
			document.querySelector(this).prev('.megamenu').slideToggle(900);
		});
		//Menu Toggle Btn
		...
		//Menu Toggle Btn
		document.querySelector('.mobile-menu .menu-backdrop,.mobile-menu .close-btn').addEventListener('click', function() {
